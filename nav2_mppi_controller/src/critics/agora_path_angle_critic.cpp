...
#include "nav2_mppi_controller/critics/agora_path_angle_critic.hpp"
...
void AgoraPathAngleCritic::initialize()
{
...
void AgoraPathAngleCritic::score(CriticData & data)
{
  ...
  auto offseted_idx = std::min(path_carrot_index_, (int) data.path.x.shape(0) - 1);
...
PLUGINLIB_EXPORT_CLASS(
  mppi::critics::AgoraPathAngleCritic,
